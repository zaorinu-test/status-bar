...
(function () {
    ...
    function injectStyles() {
        ...
        s.id = "sb-s";
        s.textContent = `
            #status-bar { position:fixed; top:0; left:0; width:100%; height:35px; z-index:99999; background:#FFF2C6; display:none; align-items:center; justify-content:flex-start; overflow:hidden; transition:transform .6s; }
